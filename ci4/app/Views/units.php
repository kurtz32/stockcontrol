<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="mb-4">
            <a href="<?= base_url('add-unit') ?>" class="btn btn-primary">Add Unit</a>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="<?= base_url('edit-unit/' . str_replace(['+', '/', '='], ['-', '_', ''], base64_encode($encrypter->encrypt($unit['id'])))) ?>">Edit</a>
                                                    <form action="<?= base_url('data/delete-unit') ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this unit?');">
                                                        <input type="hidden" name="id" value="<?= str_replace(['+', '/', '='], ['-', '_', ''], base64_encode($encrypter->encrypt($unit['id']))) ?>">
