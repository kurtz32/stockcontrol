                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form action="<?= base_url('data/edit-unit') ?>" method="post" autocomplete="off">
                                            <div class="form-group">
                                                <label>Unit Name</label> <b class="text-danger">*</b>
                                                <input type="text" name="name" value="<?= isset($input['name']) ? $input['name'] : $unit['name'] ?>" class="form-control<?= (isset($errors['name']) ? ' is-invalid' : '') ?>">
