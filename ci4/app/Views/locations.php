<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="mb-4">
            <a href="<?= base_url('add-location') ?>" class="btn btn-primary">Add Room/ Location</a>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="<?= base_url('edit-location/' . str_replace(['+', '/', '='], ['-', '_', ''], base64_encode($encrypter->encrypt($location['id'])))) ?>">Edit</a>
                                                    <form action="<?= base_url('data/delete-location') ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this room/ location?');">
                                                        <input type="hidden" name="id" value="<?= str_replace(['+', '/', '='], ['-', '_', ''], base64_encode($encrypter->encrypt($location['id']))) ?>">
