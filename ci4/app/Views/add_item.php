                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Add New <?= $title ?> Form</h4>
                                    </div>
                                    <div class="card-body">
                                        <?php
                                        ...
                                        ?>
                                        <form action="<?= base_url('data/add-item') ?>" method="post" autocomplete="off">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="unit" class="form-control<?= (isset($errors['unit']) ? ' is-invalid' : '') ?>">
                                                            ...
                                                            <?php foreach ($units as $unit) : ?>
                                                                <option value="<?= $unit['id'] ?>" <?= isset($input['unit']) && $input['unit'] == $unit['id'] ? 'selected' : '' ?>><?= $unit['name'] ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="quantity" value="<?= isset($input['quantity']) && !isset($errors['quantity']) ? $input['quantity'] : '' ?>" class="form-control<?= (isset($errors['quantity']) ? ' is-invalid' : '') ?>">
                                                        <small class="text-danger"><?= isset($errors['quantity']) ? $errors['quantity'] : '' ?></small>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Unit Cost</label> <b class="text-danger">*</b>
                                                        <input type="text" name="unit_cost" value="<?= isset($input['unit_cost']) && !isset($errors['unit_cost']) ? $input['unit_cost'] : '' ?>" class="form-control<?= (isset($errors['unit_cost']) ? ' is-invalid' : '') ?>">
                                                        <small class="text-danger"><?= isset($errors['unit_cost']) ? $errors['unit_cost'] : '' ?></small>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Accuisition Date</label> <b class="text-danger">*</b>
                                                        <input type="text" name="accuisition_date" value="<?= isset($input['accuisition_date']) ? $input['accuisition_date'] : '' ?>" class="form-control datetimepicker<?= (isset($errors['accuisition_date']) ? ' is-invalid' : '') ?>">
                                                        <small class="text-danger"><?= isset($errors['accuisition_date']) ? $errors['accuisition_date'] : '' ?></small>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label><?= $title == 'Supplies' ? 'Stock No.' : 'Property No.' ?></label> <b class="text-danger">*</b>
                                                        <input type="text" name="item_no" value="<?= isset($input['item_no']) ? $input['item_no'] : '' ?>" class="form-control<?= (isset($errors['item_no']) ? ' is-invalid' : '') ?>">
                                                        <small class="text-danger"><?= isset($errors['item_no']) ? $errors['item_no'] : '' ?></small>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>P.R. No.</label> <b class="text-danger">*</b>
                                                        <input type="text" name="pr_no" value="<?= isset($input['pr_no']) ? $input['pr_no'] : '' ?>" class="form-control<?= (isset($errors['pr_no']) ? ' is-invalid' : '') ?>">
                                                        <small class="text-danger"><?= isset($errors['pr_no']) ? $errors['pr_no'] : '' ?></small>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>I.A.R. No.</label> <b class="text-danger">*</b>
                                                        <input type="text" name="iar_no" value="<?= isset($input['iar_no']) ? $input['iar_no'] : '' ?>" class="form-control<?= (isset($errors['iar_no']) ? ' is-invalid' : '') ?>">
